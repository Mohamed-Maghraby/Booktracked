...
async function addBook(req, res) {
    ...
    const query = 'INSERT INTO books (book_id, title, author, cover, download_html, download_epup) VALUES (?, ?, ?, ?, ?, ?)';
    const values = [data.book_id, data.title, data.author, data.cover, data.download_html, data.download_epub];
